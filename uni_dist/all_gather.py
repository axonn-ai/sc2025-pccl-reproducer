...
def all_gather_2D(output_tensor: torch.Tensor,
    ...
    _all_gather(output_intermediate, input_tensor, group.get_outer_group(), async_op=False, use_rd=use_rd)

    # Step-2 intra-node all-gather
    _all_gather(output_tensor, output_intermediate, group.get_inner_group(), async_op=False, use_rd=use_rd)
